...
GAMMA_DIR = Path("results/mobility/2016_2017/1")
BETA_OUT_DIR = Path("results/model/2016_2017/1/beta")
RT_OUT_DIR = Path("results/model/2016_2017/1/rt")
FIG_OUT_DIR = Path("results/figures/model/2016_2017/1")
...
def main():
    ...
    korea = run_region(
        ...
        beta_csv_filename="Korea_beta_1(2016~2017).csv",
        rt_csv_filename="Korea_rt_1(2016~2017).csv",
    ...
    seoul = run_region(
        ...
        gamma_filename="Seoul_gamma.csv",
        beta_csv_filename="Seoul_beta_1(2016~2017).csv",
        rt_csv_filename="Seoul_rt_1(2016~2017).csv",
    ...
    busan = run_region(
        ...
        beta_csv_filename="Busan_beta_1(2016~2017).csv",
        rt_csv_filename="Busan_rt_1(2016~2017).csv",
    ...
    daejeon = run_region(
        ...
        beta_csv_filename="Daejeon_beta_1(2016~2017).csv",
        rt_csv_filename="Daejeon_rt_1(2016~2017).csv",
    ...
    daegu = run_region(
        ...
        beta_csv_filename="Daegu_beta_1(2016~2017).csv",
        rt_csv_filename="Daegu_rt_1(2016~2017).csv",
    ...
    gwangju = run_region(
        ...
        beta_csv_filename="Gwangju_beta_1(2016~2017).csv",
        rt_csv_filename="Gwangju_rt_1(2016~2017).csv",
    ...
    pt.ylabel("beta")
    pt.xlabel("Date")
    pt.savefig(FIG_OUT_DIR / "2016~2017_1_beta.png", format="png", bbox_inches="tight")
    pt.show()
    ...
    pt.ylabel("$R_t$")
    pt.xlabel("Date")
    pt.savefig(FIG_OUT_DIR / "2016~2017_1_Rt.png", format="png", bbox_inches="tight")
    pt.show()
